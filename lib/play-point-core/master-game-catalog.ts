...
/**
 * Consumer-facing master inventory for Play Amplified. Shot Caddy remains a
...
export const MASTER_GAME_CATALOG: readonly MasterGameEntry[] = [
  ...
  { id: "live-craps", title: "Live Craps", family: "Play Amplified", lane: "social", status: "live", href: "/play-amplified/games/live-craps", launchHref: "/games/live-craps", description: "Multiplayer craps with each phone acting as a live table seat, using physical or virtual dice." },
  ...
  { id: "battle-mode", title: "Battle Mode", family: "Shot Caddy", lane: "course", status: "live", href: "/play-amplified/games/battle-mode", launchHref: "/shot-caddy/mode/battle", description: "Tokens, tactics, and momentum on every hole." },
  { id: "call-your-score", title: "Call Your Score", family: "Shot Caddy", lane: "course", status: "live", href: "/play-amplified/games/call-your-score", launchHref: "/shot-caddy/mode/cys", description: "Call the result before the hole, then back up the prediction." },
  { id: "challenge-skins-pro", title: "Challenge Skins Pro", family: "Shot Caddy", lane: "course", status: "live", href: "/play-amplified/games/challenge-skins-pro", launchHref: "/shot-caddy/mode/csp", description: "A focused challenge winner on every hole." },
  { id: "wolf", title: "Wolf", family: "Shot Caddy", lane: "course", status: "live", href: "/play-amplified/games/wolf", launchHref: "/shot-caddy/mode/wolf", description: "Rotating alliances, partner decisions, and Lone Wolf pressure." },
  { id: "redemption-wolf", title: "Redemption Wolf", family: "Shot Caddy", lane: "course", status: "live", href: "/play-amplified/games/redemption-wolf", launchHref: "/shot-caddy/mode/redemption-wolf", description: "A Wolf variant that gives the trailing player the next strategic opening." },
  { id: "wolf-pack", title: "Wolf Pack", family: "Shot Caddy", lane: "course", status: "live", href: "/play-amplified/games/wolf-pack", launchHref: "/shot-caddy/mode/wolf-pack", description: "Build the only team on the card or hunt the pack alone." },

  { id: "card-shark-classic", title: "Card Shark · Classic", parentTitle: "Card Shark", family: "Shot Caddy", lane: "backyard", status: "live", href: "/play-amplified/games/card-shark-classic", launchHref: "/shot-caddy/mode/card-shark", description: "Earn playing cards through successful attempts and build the best hand." },
  { id: "card-shark-stud", title: "Card Shark · Stud", parentTitle: "Card Shark", family: "Shot Caddy", lane: "backyard", status: "live", href: "/play-amplified/games/card-shark-stud", launchHref: "/shot-caddy/mode/card-shark", description: "Stud-style Card Shark with cards earned through live play." },
  { id: "card-shark-draw", title: "Card Shark · Draw", parentTitle: "Card Shark", family: "Shot Caddy", lane: "backyard", status: "live", href: "/play-amplified/games/card-shark-draw", launchHref: "/shot-caddy/mode/card-shark", description: "Draw-style Card Shark with a live replacement-card decision." },
  { id: "atw-ladder", title: "Around The World · Ladder", parentTitle: "Around The World", family: "Shot Caddy", lane: "backyard", status: "live", href: "/play-amplified/games/atw-ladder", launchHref: "/shot-caddy/mode/around-the-world", description: "Clear stations in order around a single basket." },
  { id: "atw-sprint", title: "Around The World · Sprint", parentTitle: "Around The World", family: "Shot Caddy", lane: "backyard", status: "live", href: "/play-amplified/games/atw-sprint", launchHref: "/shot-caddy/mode/around-the-world", description: "A faster station-race format." },
  { id: "atw-survival", title: "Around The World · Survival", parentTitle: "Around The World", family: "Shot Caddy", lane: "backyard", status: "live", href: "/play-amplified/games/atw-survival", launchHref: "/shot-caddy/mode/around-the-world", description: "Stay alive as Around The World gets harder." },
  { id: "disc-warrior", title: "Disc Warrior", family: "Shot Caddy", lane: "backyard", status: "live", href: "/play-amplified/games/disc-warrior", launchHref: "/shot-caddy/mode/disc-warrior", description: "A six-throw value ladder with modifiers and a Game Master." },
