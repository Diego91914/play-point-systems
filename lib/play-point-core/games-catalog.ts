...
export type PlayPointGameCatalogItem = {
  ...
  /** Explicit launch switch. A planned price alone never makes a product sellable. */
  purchasable: boolean;
...
export const PLAY_POINT_GAME_CATALOG: readonly PlayPointGameCatalogItem[] = [
  ...
  },
  {
    ...
    href: "/shot-caddy/mode/classic?variant=CLASSIC",
    external: false,
    badge: "Ready to sell",
  ...
  },
  {
    ...
    href: "/shot-caddy/mode/classic?variant=CHAOS",
    external: false,
    badge: "Ready to sell",
    ownershipAuthority: "shot_caddy",
  },
  ...
  },
  {
    ...
    href: "/shot-caddy/mode/card-shark",
    external: false,
    badge: "Ready to sell",
    ownershipAuthority: "shot_caddy",
  },
  {
    ...
    href: "/shot-caddy/mode/quest-caddy",
    external: false,
    badge: "Ready to sell",
    ownershipAuthority: "shot_caddy",
  },
