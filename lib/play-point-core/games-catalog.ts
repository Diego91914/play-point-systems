...
export const PLAY_POINT_GAME_CATALOG: readonly PlayPointGameCatalogItem[] = [
  ...
  { sku:"game.on_my_list", title:"On My List", family:"Play Point Games", description:"One player builds a private ranked answer board. Everyone else takes turns trying to uncover the list before two misses knock them out of the board.", href:"/games/on-my-list", external:false, badge:"Playable preview", ownershipAuthority:"play_point" },
  { sku:"game.inside_man", title:"The Inside Man", family:"Play Point Games", description:"A phone-powered social deduction game: complete group missions while one hidden player secretly steers the table toward failure.", href:"/games/inside-man", external:false, badge:"Playable preview", ownershipAuthority:"play_point" },
