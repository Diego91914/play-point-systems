...
const OVERRIDES: Record<string, Record<string, AnswerOverrides>> = {
  "blackwood-business-partner": {
    partner: {
      ...
      after: { mustReveal: "Claim you stayed with the copied records in the study.", mayHide: "You used the rear route after the fatal confrontation." },
      ...
      door: { mustReveal: "Say you only noticed the back door later around 10:42.", mayHide: "You used the rear route earlier." },
    ...
    murderer: {
      ...
      after: { mustReveal: "You returned from the bathroom area and did not use the back route." },
  ...
  "blackwood-younger-sister": {
    sister: {
      ...
      after: { mustReveal: "Claim you remained outside and continued dealing with the accountant call.", mayHide: "You used the rear route to return outside after the confrontation." },
      ...
      door: { mustReveal: "Say you cannot account for who used the rear route during the death window.", mayHide: "You used it yourself." },
  ...
  "blackwood-private-chef": {
    chef: {
      ...
      after: { mustReveal: "Claim you continued kitchen cleanup.", mayHide: "You returned through the rear route and rinsed away a kitchen-related trace." },
      ...
      door: { mustReveal: "Say the back door was not fully latched when you noticed it later.", mayHide: "You used that route after the confrontation." },
