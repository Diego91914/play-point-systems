...
import { buildTriviaLivePlayerSnapshot, submitTriviaLiveAnswer } from "../../../../../../../games/trivia/play/trivia-live-session";
...
export async function POST(
  ...
  try {
    submitTriviaLiveAnswer(sessionId, playerId, body.response);
