...
export default function Page(){return <SiteShell current="games"><RoomInviteSessionGuard storageKey="pps-on-my-list-session"><OnMyListClient/><RulesCorner game="on-my-list"/></RoomInviteSessionGuard></SiteShell>}
