...
export default function Page(){return <SiteShell current="games"><GameAtmosphere variant="social"><RoomInviteSessionGuard storageKey="pps-on-my-list-session"><OnMyListClient/><RulesCorner game="on-my-list"/><SocialRoomController game="on-my-list" storageKey="pps-on-my-list-session" roomApiBase="/api/games/on-my-list"/></RoomInviteSessionGuard></GameAtmosphere></SiteShell>}
