            ...
            <div className="mt-8 grid gap-7 lg:grid-cols-[1.15fr_0.85fr] lg:items-end">
              <div>
                ...
                <h1 className="marketing-headline mt-5 lg:text-7xl">
                  Pick a game. Change the table.
                </h1>
                <p className="mt-5 max-w-3xl text-lg leading-8 text-white/72">
                  Choose the kind of night you want, then let the phones run the game instead of distracting from it. Your Play Point titles and connected Shot Caddy experiences launch from here.
                </p>
                <div className="mt-5 flex flex-wrap gap-2 text-[11px] font-black uppercase tracking-[0.16em] text-white/48">
                  <span className="rounded-full border border-white/10 bg-black/20 px-3 py-2">Laugh together</span>
                  <span className="rounded-full border border-white/10 bg-black/20 px-3 py-2">Outthink the room</span>
                  <span className="rounded-full border border-white/10 bg-black/20 px-3 py-2">Enter a story</span>
                  <span className="rounded-full border border-white/10 bg-black/20 px-3 py-2">Compete live</span>
                </div>
              </div>
              ...
              <aside className="rounded-[28px] border border-cyan-300/15 bg-cyan-300/[0.06] p-5 backdrop-blur-sm">
                ...
                <p className="mt-2 text-sm leading-6 text-white/58">
                  {founder
                    ...
                    : "Locked Play Point titles stay visible so this shelf can become the home for purchases and future unlocks."}
                </p>
              </aside>
            </div>
        ...
        <section className="border-t border-white/10 px-5 py-10 sm:px-8 lg:px-10 lg:py-14">
          <div className="mx-auto max-w-6xl">
            <div className="mb-6 flex flex-wrap items-end justify-between gap-3">
              <div>
                <div className="text-[11px] font-black uppercase tracking-[0.2em] text-cyan-100/55">Choose your game</div>
                <h2 className="mt-2 text-2xl font-black text-white sm:text-3xl">What sounds good tonight?</h2>
              </div>
              <div className="text-sm text-white/45">Tap a title and go.</div>
            </div>
            ...
            <div className="grid gap-5 md:grid-cols-2 xl:grid-cols-3">
              {library.map((game) => {
                ...
                const card = (
                  <article className="flex h-full flex-col rounded-[30px] border border-white/10 bg-[linear-gradient(145deg,rgba(255,255,255,0.065),rgba(255,255,255,0.022))] p-6 shadow-[0_18px_50px_rgba(0,0,0,0.18)] backdrop-blur-sm">
                ...
                return game.external ? (
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="block rounded-[30px] transition duration-200 hover:-translate-y-1 hover:brightness-110 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-cyan-300"
                  >
                    {card}
                  </a>
                ) : (
