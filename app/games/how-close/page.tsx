...
export default function Page(){return <SiteShell current="games"><RoomInviteSessionGuard storageKey="pps-how-close-session"><HowCloseClient/><RulesCorner game="how-close"/><SocialRoomController game="how-close" storageKey="pps-how-close-session" roomApiBase="/api/games/how-close"/></RoomInviteSessionGuard></SiteShell>}
