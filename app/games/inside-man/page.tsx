...
export default function Page(){return <SiteShell current="games"><RoomInviteSessionGuard storageKey="pps-inside-man-session"><InsideManClient/></RoomInviteSessionGuard></SiteShell>}
