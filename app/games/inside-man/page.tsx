...
export default function Page(){return <SiteShell current="games"><RoomInviteSessionGuard storageKey="pps-inside-man-session"><InsideManClient/><RulesCorner game="inside-man"/><SocialRoomController game="inside-man" storageKey="pps-inside-man-session" roomApiBase="/api/games/inside-man"/></RoomInviteSessionGuard></SiteShell>}
