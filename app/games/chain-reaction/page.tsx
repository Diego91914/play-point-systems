...
export default function Page(){ return <SiteShell current="games"><GameAtmosphere variant="social"><RoomInviteSessionGuard storageKey="pps-chain-reaction-session"><ChainReactionClient/><RulesCorner game="chain-reaction"/><SocialRoomController game="chain-reaction" storageKey="pps-chain-reaction-session" roomApiBase="/api/games/chain-reaction"/></RoomInviteSessionGuard></GameAtmosphere></SiteShell>; }
