...
function requiredGameSku(pathname: string): string | null {
  ...
  if (pathname === "/games/get-there") return "game.get_there";
  return null;
}
...
export async function proxy(request: NextRequest) {
  ...
  const isFamilyJoinPage = hasRoomCode && (pathname === "/games/chain-reaction" || pathname === "/games/how-close" || pathname === "/games/get-there");
  const isFamilyRoomApi = pathname === "/api/games/chain-reaction" || pathname.startsWith("/api/games/chain-reaction/") || pathname === "/api/games/how-close" || pathname.startsWith("/api/games/how-close/") || pathname === "/api/games/get-there" || pathname.startsWith("/api/games/get-there/");
